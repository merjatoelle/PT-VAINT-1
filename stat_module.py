...
# Parameter list for field analysis (mode 8)
...
if mode == 1:
    ...
    aevap_st_orig_a  = isd.stat_tepm(df_cosmo_orig['AEVAP_S'], gl_Eta, 'COSMO_Epa'      )  # was gl_Epa
    aevap_st_orig_b  = isd.stat_tepm(df_cosmo_orig['AEVAP_S'], gl_Etb, 'COSMO_Epb'      )  # was gl_Epb
    zverbo_st_orig_a = isd.stat_tepm(df_cosmo_orig['ZVERBO'] , gl_Epa, 'COSMO_Eta'      )  # was gl_Eta
    zverbo_st_orig_b = isd.stat_tepm(df_cosmo_orig['ZVERBO'] , gl_Epb, 'COSMO_Etb'      )  # was gl_Etb
    ...
    aevap_st_35_a    = isd.stat_tepm(df_cosmo_v35['AEVAP_S'] , gl_Eta, 'COSMO_v3.5_Epa'     )
    aevap_st_35_b    = isd.stat_tepm(df_cosmo_v35['AEVAP_S'] , gl_Etb, 'COSMO_v3.5_Epb'     )
    zverbo_st_35_a   = isd.stat_tepm(df_cosmo_v35['ZVERBO']  , gl_Epa, 'COSMO_v3.5_Eta'     )
    zverbo_st_35_b   = isd.stat_tepm(df_cosmo_v35['ZVERBO']  , gl_Epb, 'COSMO_v3.5_Etb'     )
    ...
    aevap_st_45_a   = isd.stat_tepm(df_cosmo_v45['AEVAP_S'] , gl_Eta, 'COSMO_v4.5_Epa'      )
    aevap_st_45_b   = isd.stat_tepm(df_cosmo_v45['AEVAP_S'] , gl_Etb, 'COSMO_v4.5_Epb'      )
    zverbo_st_45_a  = isd.stat_tepm(df_cosmo_v45['ZVERBO']  , gl_Epa, 'COSMO_v4.5_Eta'      )
    zverbo_st_45_b  = isd.stat_tepm(df_cosmo_v45['ZVERBO']  , gl_Epb, 'COSMO_v4.5_Etb'      )
    ...
    aevap_st_45e_a  = isd.stat_tepm(df_cosmo_v45e['AEVAP_S'], gl_Eta, 'COSMO_v4.5e_Epa'     )
    aevap_st_45e_b  = isd.stat_tepm(df_cosmo_v45e['AEVAP_S'], gl_Etb, 'COSMO_v4.5e_Epb'     )
    zverbo_st_45e_a = isd.stat_tepm(df_cosmo_v45e['ZVERBO'] , gl_Epa, 'COSMO_45e_Eta'       )
    zverbo_st_45e_b = isd.stat_tepm(df_cosmo_v45e['ZVERBO'] , gl_Epb, 'COSMO_45e_Etb'       )
...
#------------------------------------------------------------------------------    
    ...
    for i in range(len(par_list)):
        ...
        dav_res = stf.DAV_analysis(sf_field_stat, fn_region, par_list[i], refer, ds_name)
