...
if mode == 1:
    ...
    ep_v35a = flnt.montly_data(df_v35a['Ep'], daily_period, time_step)                # Ep --> potential evaporation
    et_v35a = flnt.montly_data(df_v35a['Et'], daily_period, time_step)                # Et --> transpiration 
...
#Doesn't work
    ...
    aevap_st_orig_a  = isd.stat_tepm(cclm_ref['AEVAP_S'], gl_Eta, 'CCLMref_Eta'       )  # was gl_Epa
    aevap_st_orig_b  = isd.stat_tepm(cclm_ref['AEVAP_S'], gl_Etb, 'CCLMref_Etb'       )  # was gl_Epb
    zverbo_st_orig_a = isd.stat_tepm(cclm_ref['ZVERBO'] , gl_Epa, 'CCLMref_Epa'       )  # was gl_Eta
    zverbo_st_orig_b = isd.stat_tepm(cclm_ref['ZVERBO'] , gl_Epb, 'CCLMref_Epb'       )  # was gl_Etb
