...
#print(y_w_3)          
    ...
    fig = plt.figure(figsize = (14,10))
    ax  = fig.add_subplot(111)       
    ax.plot(cclm_mean.index     , cclm_mean['AEVAP_S']       , label = 'COSMOref', color = 'blue'  , linestyle = '-' )
    ax.plot(cclm_v35_mean.index , cclm_v35_mean['AEVAP_S']   , label = 'COSMO35', color = 'green'  , linestyle = '-' )
    ax.plot(cclm_v45_mean.index , cclm_v45_mean['AEVAP_S']   , label = 'COSMO45', color = 'brown', linestyle = '-'  ) 
    ax.plot(cclm_v45e_mean.index, cclm_v45e_mean['AEVAP_S']  , label = 'COSMO45e', color = 'red'  , linestyle = '-'  )
    
    
    ax.plot(ep_v35a.index, ep_v35a, label = 'Ep v3.5a', color = 'black', linestyle = '-.')  
    ax.plot(ep_v35b.index, ep_v35b, label = 'Ep v3.5b', color = 'black', linestyle = '--' )

    ax.plot(et_v35a.index, et_v35a, label = 'Et v3.5a', color = 'lime', linestyle = '-.')  
    ax.plot(et_v35b.index, et_v35b, label = 'Et v3.5b', color = 'lime', linestyle = '--' )      
    
    ax.legend() 
    
    plt.savefig(result_path[0] +'1.png', format = 'png', dpi = 300) 

    # plot for zverbo

    fig = plt.figure(figsize = (14,10))
    bx  = fig.add_subplot(111)       
    bx.plot(cclm_mean.index     , cclm_mean['ZVERBO']       , label = 'COSMOref', color = 'blue'  , linestyle = '-' )
    bx.plot(cclm_v35_mean.index , cclm_v35_mean['ZVERBO']   , label = 'COSMO35', color = 'green'  , linestyle = '-' )
    bx.plot(cclm_v45_mean.index , cclm_v45_mean['ZVERBO']   , label = 'COSMO45', color = 'brown', linestyle = '-'  ) 
    bx.plot(cclm_v45e_mean.index, cclm_v45e_mean['ZVERBO']  , label = 'COSMO45e', color = 'red'  , linestyle = '-'  )
    
    
    bx.plot(ep_v35a.index, ep_v35a, label = 'Ep v3.5a', color = 'black', linestyle = '-.')  
    bx.plot(ep_v35b.index, ep_v35b, label = 'Ep v3.5b', color = 'black', linestyle = '--' )      

    bx.plot(et_v35a.index, et_v35a, label = 'Et v3.5a', color = 'lime', linestyle = '-.')  
    bx.plot(et_v35b.index, et_v35b, label = 'Et v3.5b', color = 'lime', linestyle = '--' )  
    
    bx.legend() 
    
    plt.savefig(result_path[0] +'2.png', format = 'png', dpi = 300) 
