...
#------------------------------------------------------------------------------
sf_parc01_ctr     = 'COSMO/PARC/CTR/'                                          # The subfolder for original COSMO data
sf_parc_v35       = 'COSMO/PARC/v3.5/'                                         # The subfolder for experiment data
sf_parc_v45       = 'COSMO/PARC/v4.5/'                                         # The subfolder for experiment data
sf_parc_v45_evap  = 'COSMO/PARC/v4.5e/'                                        # The subfolder for experiment data
...
#------------------------------------------------------------------------------
# Subsubfolders for statisical analysis
#------------------------------------------------------------------------------
'''
...
#------------------------------------------------------------------------------
"""
stat_metric = stat.statistic(mf_com, sf_statistic, sssf_region, refer, ds_name)
"""
#------------------------------------------------------------------------------
