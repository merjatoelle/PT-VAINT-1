...
DIR_COSMO_EXP=${DIR}/Lindenberg_v3.5/post
DIR_RESULT=${DIR}/results/COSMO_exp/LINDENBERG_v3.5
DIR_F_RESULT=/pf/b/b381275/COSMO_results/LINDENBERG/v3.5

# Additional path for COSMO field results
DIR_COSMO_RS=${DIR}/COSMO/lindenberg_domain/3.5/
