...
DIR_COSMO_EXP=${DIR}/Lindenberg_ctr/post
DIR_RESULT=${DIR}/results/COSMO_orig/LINDENBERG_CTR
DIR_F_RESULT=/pf/b/b381275/COSMO_results/LINDENBERG/CTR

# Additional path for COSMO field results
DIR_COSMO_RS=${DIR}/COSMO/lindenberg_domain/original
...
do
    ...
    if [ "${param}" == "ALHFL_PL_ts" ]; then
        ...
        cdo seldate,20100101,20153112 ${DIR_RESULT}/"${param}"_"vert_mean"_"${time_step}" ${DIR_RESULT}/"${param}"_"${time_step}"
        ...
        # Additional copy nc file for statistical analysis
        cdo seldate,20100101,20153112 ${DIR_RESULT}/"${param}"_"${time_step}" ${DIR_RESULT}/"${param}"_"A"_"${time_step}"
        cp -R ${DIR_RESULT}/"${param}"_"A"_"${time_step}" ${DIR_COSMO_RS}/"${param}"_"${time_step}"
        #-----------------------------------------------------------------------
