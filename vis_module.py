...
def plot_6(ax, prr_1, prr_2, prr_3, prr_4, prr_5, prr_6,
    ...
    ax.plot(prr_4.index, prr_4, label = leg_4, color = 'red'       , linestyle = ':' , 
                                                                         alpha = 0.6 )  
    ax.plot(prr_5.index, prr_5, label = leg_5, color = 'sienna'    , linestyle = '--', 
                                                                         alpha = 0.6 )      
    ax.plot(prr_6.index, prr_6, label = leg_6, color = 'tab:purple', linestyle = '-.', 
                                                                      linewidth = 0.9)    
...
def get_m(df, df2, df3, df4, df5, param, name_2, data_out, y1, y2, step, status):
    ...
    plt.plot(df.index ,  df[param], label = 'Cosmo_orig' , color = 'blue'  ,
                                                           linestyle = '-' )
    plt.plot(df2.index, df2[param], label = 'Cosmo_v3.5' , color = 'orange',
                                                          linestyle = '--' , linewidth = 2)
    plt.plot(df3.index, df3[param], label = 'Cosmo_v4.5' , color = 'green' ,
                                             linestyle = '-.', alpha = 0.4 , linewidth = 2)
    plt.plot(df4.index, df4[param], label = 'Cosmo_v4.5e', color = 'red'   ,
                                             linestyle = ':' , alpha = 0.6 , linewidth = 2)    
    
    if param == 'ALHFL_S':
        plt.plot(df5.index, df5['LE'], label = 'OBS', color = 'violet', alpha = 0.5)
    elif param == 'ASHFL_S': 
        plt.plot(df5.index, df5['H'] , label = 'OBS', color = 'violet', alpha = 0.5)            
    elif param == 'AEVAP_S':
        plt.plot(df5.index, df5['Et_a'], label = 'Gleam_v3.5a',
                                color = 'magenta', alpha = 0.5)                # was Ep_a
        plt.plot(df5.index, df5['Et_b'], label = 'Gleam_v3.5b', 
                                color = 'lime'   , alpha = 0.5)                # was Ep_b   
    elif param == 'ZVERBO':
        plt.plot(df5.index, df5['Ep_a'], label = 'Gleam_v3.5a',
                                color = 'magenta', alpha = 0.5)                # was Et_a
        plt.plot(df5.index, df5['Ep_b'], label = 'Gleam_v3.5b', 
                                color = 'lime'   , alpha = 0.5)                # was Et_b      
    elif param == 'T_2M': 
        plt.plot(df5.index, df5['T_2M'], label = 'obs', color = 'purple', 
                                                             alpha = 0.5)
    elif param == 'T_S': 
        plt.plot(df5.index, df5['TS']  , label = 'obs', color = 'purple', 
                                                             alpha = 0.5)
    elif param == 'TMAX_2M': 
        plt.plot(df5.index, df5['TMAX'], label = 'obs', color = 'purple', 
                                                             alpha = 0.5)
    elif param == 'TMIN_2M': 
        plt.plot(df5.index, df5['TMIN'], label = 'obs', color = 'purple', 
                                                             alpha = 0.5)  
...
def get_d(df, df2, df3, df4, df5, param, name_2, data_out, y1, y2, step, input_region):
    ...
    if param == 'ALHFL_S':
        ...
        plt.plot(df5.index, df5['Et_a'], label = 'Gleam_v3.5a', color = 'magenta', 
                                                                      alpha = 0.5)
        plt.plot(df5.index, df5['Et_b'], label = 'Gleam_v3.5b', color = 'lime'   ,
                                                                      alpha = 0.5)    
    elif param == 'ZVERBO':
        plt.plot(df5.index, df5['Ep_a'], label = 'Gleam_v3.5a', color = 'magenta',
                                                                      alpha = 0.5)
        plt.plot(df5.index, df5['Ep_b'], label = 'Gleam_v3.5b', color = 'lime'   , 
                                                                      alpha = 0.5)       
    elif param == 'T_2M': 
...
def get_h(df, df2, df3, df4, df5, df6, param, name_2, data_out, y1, y2, step, input_region):
    ...
    if param == 'ALHFL_S':
        ...
        plt.scatter(df6.index, df6['Ep_a'], label = 'Gleam_v3.5a', 
                                   color = 'magenta', alpha = 0.5)
        plt.scatter(df6.index, df6['Ep_b'], label = 'Gleam_v3.5b', 
...
def plot_waves(ts_main, ts_hot, ts_cold, interval, domain, station, x_start, 
    ...
    plt.plot(ts_main.index   ,  ts_main, label = 'T2_M'     , color = 'blue'  , 
                                                               linestyle = '-')
...
def plot_5_stom(ax, prr_1, prr_2, prr_3, prr_4, prr_5, 
    ...
    ax.plot(prr_1.index, prr_1, label = leg_1, color = 'blue'  , linestyle = '-'  )
    ax.plot(prr_2.index, prr_2, label = leg_2, color = 'orange', linestyle = '--' , linewidth = 2)
    ax.plot(prr_3.index, prr_3, label = leg_3, color = 'green' , linestyle = '-.' , 
    ...
    ax.set_title('Domain: ' + station_plot + '    Station: ' + nst, 
                 color = 'black', fontsize = 18, pad = 20)
    
    ax.set_ylabel(na_4, color = 'black', fontsize = 16, labelpad=20)
    ax.legend(fontsize = 14, loc = l_p)  
    ax.get_yticks()
    ax.set_yticks(np.arange(pr_3, pr_4, pr_5))
    ax.get_xticks()
    ax.tick_params(axis = 'y' , which ='major', bottom = True  , top = False,
