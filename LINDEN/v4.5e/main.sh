...
DIR_COSMO_EXP=${DIR}/Linden_v4.5_evap/post
DIR_RESULT=${DIR}/results/COSMO_exp/LINDEN_v4.5e
DIR_F_RESULT=/pf/b/b381275/COSMO_results/LINDEN/v4.5e

# Additional path for COSMO field results
DIR_COSMO_RS=${DIR}/COSMO/linden_domain/4.5e/
