...
DIR_COSMO_EXP=${DIR}/Linden_ctr/post
DIR_RESULT=${DIR}/results/COSMO_orig/LINDEN_CTR
DIR_F_RESULT=/pf/b/b381275/COSMO_results/LINDEN/CTR

# Additional path for COSMO field results
DIR_COSMO_RS=${DIR}/COSMO/linden_domain/original
