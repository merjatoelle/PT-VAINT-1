...
DIR_COSMO_EXP=${DIR}/Parc_v4.5_evap/post
DIR_RESULT=${DIR}/results/COSMO_exp/PARC_v4.5_evap
DIR_F_RESULT=/pf/b/b381275/COSMO_results/PARC_v4.5_evap

# Additional path for COSMO field results
DIR_COSMO_RS=${DIR}/COSMO/parc_domain/4.5e/
