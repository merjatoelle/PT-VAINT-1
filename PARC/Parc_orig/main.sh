...
DIR_COSMO_EXP=${DIR}/Parc01_ctr2/post
DIR_RESULT=${DIR}/results/COSMO_orig/PARC01_CTR
DIR_F_RESULT=/pf/b/b381275/COSMO_results/PARC01_CTR

# Additional path for COSMO field results
DIR_COSMO_RS=${DIR}/COSMO/parc_domain/original
