...
def KGE_RMSD_analysis(path_main, fn_region, par_list, refer, ds_name, vrs_GLEAM):
    ...
    if refer == 'HYRAS':
        ...
        s_obs  = refer   + '_' + vrs_GLEAM + '_' + par_list  + '_std_'  + fn_region + '_domain.csv'
        m_mod  = ds_name + '_' + par_list  + '_' + vrs_GLEAM + '_mean_' + fn_region + '_domain.csv'
        s_mod  = ds_name + '_' + par_list  + '_' + vrs_GLEAM + '_std_'  + fn_region + '_domain.csv'   
        c_name = 'Corr_' + refer + '_' + vrs_GLEAM + '_' + ds_name + '_' + par_list + '_' + fn_region + '_domain.csv'    
    ...
    ref_corr = abs(np.mean(df_data['P']))
...
#------------------------------------------------------------------------------
def get_pdf(data_array, par_list):
    ...
    if par_list in ('T_2M', 'T_MAX', 'T_MIN', 'T_S'):
        print ('Parameters T2m, Tmax, Tmin, Ts')       
        # Parameters DAV for T2m, Ts, Tmin, Tmax
        #----------------------------------------------------------------------
        for j in range(len(df_mod)):
            if df_mod[j] < -10.0:
                ...
                count_10 = count_10 + 1        
        #----------------------------------------------------------------------        
    elif par_list in ('AEVAP_S'):
        print ('Parameters AEVAP_S')  
        # Parameters DAV for AEVAP
        #----------------------------------------------------------------------
        for j in range(len(df_mod)):
            if df_mod[j] < -0.97:
                count_1 = count_1 + 1
            elif df_mod[j] >= -0.97 and df_mod[j] < -0.24:
                count_2 = count_2 + 1
            elif df_mod[j] >= -0.24 and df_mod[j] < 0.49: 
                count_3 = count_3 + 1
            elif df_mod[j] >=  0.49 and df_mod[j] < 1.22: 
                count_4 = count_4 + 1
            elif df_mod[j] >=  1.22 and df_mod[j] < 1.95: 
                count_5 = count_5 + 1
            elif df_mod[j] >=  1.95 and df_mod[j] < 2.68: 
                count_6 = count_6 + 1
            elif df_mod[j] >=  2.68 and df_mod[j] < 3.41: 
                count_7 = count_7 + 1
            elif df_mod[j] >=  3.41 and df_mod[j] < 4.15: 
                count_8 = count_8 + 1
            elif df_mod[j] >=  4.15 and df_mod[j] < 4.88: 
                count_9 = count_9 + 1
            else:  
                count_10 = count_10 + 1        
        #----------------------------------------------------------------------                
    elif par_list in ('ZVERBO'):
        print ('Parameters ZVERBO') 
        # Parameters DAV for ZVERBO
        #----------------------------------------------------------------------
        for j in range(len(df_mod)):
            if df_mod[j] < -0.53:
                count_1 = count_1 + 1
            elif df_mod[j] >= -0.53 and df_mod[j] < 0.37:
                count_2 = count_2 + 1
            elif df_mod[j] >= 0.37 and df_mod[j] < 1.26: 
                count_3 = count_3 + 1
            elif df_mod[j] >= 1.26 and df_mod[j] < 2.16: 
                count_4 = count_4 + 1
            elif df_mod[j] >= 2.16 and df_mod[j] < 3.05: 
                count_5 = count_5 + 1
            elif df_mod[j] >= 3.05 and df_mod[j] < 3.95: 
                count_6 = count_6 + 1
            elif df_mod[j] >= 3.95 and df_mod[j] < 4.84: 
                count_7 = count_7 + 1
            elif df_mod[j] >= 4.84 and df_mod[j] < 5.74: 
                count_8 = count_8 + 1
            elif df_mod[j] >= 5.74 and df_mod[j] < 6.63: 
                count_9 = count_9 + 1
            else:  
                count_10 = count_10 + 1        
        #----------------------------------------------------------------------        
...
#------------------------------------------------------------------------------
def DAV_analysis(path_main, fn_region,  par_list, refer, ds_name, vrs_GLEAM):      
    ...
    if refer == 'HYRAS':
        ...
        # FileNames for data - GLEAM
        d_obs = refer   + '_' + vrs_GLEAM + '_' + par_list  + '_mean_dav_' + fn_region + '_domain.csv'
        d_lr  = 'COSMO_ORIG_' + par_list  + '_' + vrs_GLEAM + '_mean_dav_' + fn_region + '_domain.csv'      
        d_hr  = ds_name + '_' + par_list  + '_' + vrs_GLEAM + '_mean_dav_' + fn_region + '_domain.csv'  
    ...
    obs = get_pdf(df_data['OBS'], par_list)
    lr  = get_pdf(df_data['LR'] , par_list)
    hr  = get_pdf(df_data['HR'] , par_list)
